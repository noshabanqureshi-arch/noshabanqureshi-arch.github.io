...
Primary next offer: **30-Day Content Starter — $27 CAD**

Value ladder:
1. Free — 30 Content Ideas for Your Business
2. $27 — 30-Day Content Starter
...
You do not need thirty completely different ideas every month.

You need a few useful themes you can return to and adapt.

Your **30 Content Ideas for Your Business** resource is ready below.

**CTA: Download the 30 ideas**

As you use it, do not worry about posting every idea. Circle the ones that connect most clearly to what your customers ask, what you sell, and what you want this month of content to accomplish.

That is where a content system starts.

— Square Social Studio

---

## Email 2 — Teach the five content jobs
**Timing:** 1 day after delivery

**Subject:** A simpler way to decide what to post

When content feels random, it is usually because every post is being asked to do everything.

Give each post one job:

- **Teach** — answer, explain, simplify.
- **Trust** — show process, standards, proof and decisions.
- **Connect** — share useful stories, values and relatable business realities.
- **Offer** — explain what you sell and who it is for.
- **Convert** — make one next step clear.

You do not need all five every day. You need enough balance that people can learn from you, understand you, understand the offer, and know what to do next.

**CTA: Choose the four pillars you will use this month**

---

## Email 3 — Introduce the $27 Starter
**Timing:** 2 days after Email 2

**Subject:** You have ideas. Now build the month.

A list of ideas solves the blank-page problem.

The next problem is turning those ideas into a month that actually supports the business.

The **30-Day Content Starter** helps you:

- choose one 30-day goal,
- define the customer you are speaking to,
- choose your content pillars,
- plan 30 purposeful posts,
- write hooks and CTAs,
- plan simple Reels,
- and use AI without letting it invent your brand voice or expertise.

It is **$27 CAD**.

**CTA: See the 30-Day Content Starter**

---

## Email 4 — Teach the Show Up Simply method
**Timing:** 2 days after Email 3

**Subject:** The content system in five words

The Square Social Studio method is deliberately simple:

**Clarify → Plan → Create → Publish → Repeat**

Clarify the goal, audience and voice.

Plan the customer journey, content pillars and channels.

Create useful copy and video using repeatable structures.

Publish through a workflow you can maintain.

Repeat what the evidence says is working.

The point is not to create more content. It is to stop rebuilding your process from zero every week.

**CTA: See the Show Up Simply pathway**

---

## Email 5 — Let the customer choose the level
**Timing:** 3 days after Email 4

**Subject:** Where are you getting stuck?

You may not need the biggest program.

Choose the level that matches the bottleneck:

**$27 — 30-Day Content Starter**
For: “I never know what to post.”

**$69 — 30 Days of Content in 60 Minutes**
For: “I want someone to walk me through planning the month.”

**$149 — Show Up Simply™ Toolkit**
For: “I need the complete set of planning, writing, Reels, dashboard and launch tools.”

**$349 — Show Up Simply™ Content System**
For: “I want the full strategy and guided implementation system.”

**CTA: Compare the offers**

Choose the smallest level that solves the problem you have now. You can build from there.
